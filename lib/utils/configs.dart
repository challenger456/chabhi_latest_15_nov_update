...
const APP_NAME = 'Chabhi Partner';
const DEFAULT_LANGUAGE = 'en';

const primaryColor = Color(0xFF01A5B1);

const DOMAIN_URL = "https://chabhi.com";
...
const TERMS_CONDITION_URL = 'https://chabhi.com/term-conditions';
const PRIVACY_POLICY_URL = 'https://chabhi.com/privacy-policy';
const HELP_AND_SUPPORT_URL = 'https://chabhi.com/help-support';
const REFUND_POLICY_URL = 'https://chabhi.com/refund-policy';
const INQUIRY_SUPPORT_EMAIL = 'hello@chabhi.com';
